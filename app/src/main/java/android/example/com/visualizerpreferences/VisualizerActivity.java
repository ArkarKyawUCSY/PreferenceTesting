...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadColorBySharedPreference(sharedPreferences);
    ...
    private void loadColorBySharedPreference(SharedPreferences sharedPreferences) {
    ...
    private void loadSizeFromSharedPreference(SharedPreferences sharedPreferences) {
        float miniSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_size_key),
                getString(R.string.pref_size_default)));
        mVisualizerView.setMinSizeScale(miniSize);
